var objGooglebarLiteOptions = {
	LoadOptions: function()
	{
		...
		document.getElementById("GBL-Opt-DisableAutoCorrect").checked	= b.getBoolPref(oGBL.PrefName_DisableAutoCorrect);
	...
	SaveOptions: function()
	{
		...
		b.setBoolPref(oGBL.PrefName_DisableAutoCorrect, document.getElementById("GBL-Opt-DisableAutoCorrect").checked);
